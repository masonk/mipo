        ...
        commands
            .spawn((
                PbrBundle {
                    ...
                    transform: Transform::from_scale(Vec3::new(3., 300., 3.0)),
                    ..default()
                },
                RigidBody::Fixed,
...
fn spawn_light(mut commands: Commands) {
    commands.spawn((
        DirectionalLightBundle {
            ...
            transform: Transform::from_xyz(-50., 900., -50.)
                .looking_at(Vec3::new(150., 150., 150.), Vec3::Y),
            ..default()
        },
        Name::new(format!("world_directional_light")),
    ));
}
